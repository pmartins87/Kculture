"""Apply the frozen CR081 v3 promotion gate; no parameter/strategy selection."""
...
def main():
    ...
    report={
        'schema_version':'cr081-promotion-gate-v3-fidelity',
        ...
        'invalid_prior_runs':[34671122716,34671446692],
    }
