#!/usr/bin/env python3
"""Aggregate O-LQ1 parallel causal shards with frozen causal gate."""
...
def main():
    ...
    result={
        "schema":"kculture-o-lq1-v48-causal-parallel-v1",
        "mechanical_pass":mech,"shards":len(shards),
    ...
    print("O_LQ1_V48_CAUSAL_RESULT",json.dumps({
        "decision":decision,"mechanical_pass":mech,"summary":summary,"failures":len(failures)
